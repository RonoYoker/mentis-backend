...
class TelegramUtility:
    ...
    def __int__(self):
        self.telegram_vendor_config = nested_path_get(settings.vendor_config, "telegram", default_return_value = {})
    ...
    def send_telegram_message(self, chat_id_list: list, message_body: str):
        ...
        url = self.telegram_vendor_config.get("API_URL")

        sandesh_payload = {
            "request_type": "bulk",
            "config_id": self.telegram_vendor_config.get("CONFIG_ID", "default_telegram"),
            "client": self.telegram_vendor_config.get("CLIENT", "HYPERION"),
            "var_data": var_data,
            "channel": "TELEGRAM",

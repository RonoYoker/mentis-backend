...
from onyx_proj.models.CreditasCampaignEngine import CED_CampaignBuilderWhatsApp
...
class CEDCampaignBuilderWhatsApp:
    def __init__(self, **kwargs):
        ...
        self.table = CED_CampaignBuilderWhatsApp
    ...
    def get_whatsapp_campaign(self, unique_id):
        filter_list = [

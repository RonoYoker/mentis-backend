...
class CEDHisCampaignBuilderSms:
    def __init__(self, **kwargs):
        self.database = kwargs.get("db_conf_key", "default")
        self.table_name = "CED_HIS_CampaignBuilderSMS"
        self.curr = mysql_connect(self.database)
        self.table = CED_HIS_CampaignBuilderSMS
    ...
    def save_campaign_builder_campaign_history(self, campaign_history_whatsapp_entity):

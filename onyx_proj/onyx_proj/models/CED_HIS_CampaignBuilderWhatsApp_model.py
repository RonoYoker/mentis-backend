...
class CEDHisCampaignBuilderWhatsapp:
    def __init__(self, **kwargs):
        self.database = kwargs.get("db_conf_key", "default")
        self.table_name = "CED_HIS_CampaignBuilderWhatsApp"
        self.curr = mysql_connect(self.database)
        self.table = CED_HIS_CampaignBuilderWhatsApp
    ...
    def save_campaign_builder_campaign_whatsapp_history(self, campaign_history_whatsapp_entity):
        res = save_or_update_merge(self.engine, campaign_history_whatsapp_entity)
        return res

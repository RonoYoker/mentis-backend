...
class CED_CampaignSchedulingSegmentDetails(Base, Orm_helper):
    __tablename__ = "CED_CampaignSchedulingSegmentDetails"
    ...
    scheduling_status = Column("SchedulingStatus", String)
    scheduling_time = Column("SchedulingTime", String)

...
class CED_HIS_CampaignBuilderEmail(Base, Orm_helper):
    __tablename__ = 'CED_HIS_CampaignBuilderEmail'

    id = Column("Id", Integer, unique=True, autoincrement=True)
    unique_id = Column("UniqueId", String, primary_key=True)
    campaign_builder_email_entity_id = Column("CampaignBuilderEmailEntityId", String)

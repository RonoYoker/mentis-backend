...
class CED_HIS_CampaignBuilderIVR(Base, Orm_helper):
    __tablename__ = 'CED_HIS_CampaignBuilderIVR'
    ...
    campaign_builder_ivr_entity_id = Column("CampaignBuilderIVREntityId", String)

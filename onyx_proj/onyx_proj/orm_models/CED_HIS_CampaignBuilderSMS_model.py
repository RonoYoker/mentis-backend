...
class CED_HIS_CampaignBuilderSMS(Base, Orm_helper):
    __tablename__ = 'CED_HIS_CampaignBuilderSMS'

    id = Column("Id", Integer, unique=True, autoincrement=True)
    unique_id = Column("UniqueId", String, primary_key=True)
    campaign_builder_sms_entity_id = Column("CampaignBuilderSMSEntityId", String)

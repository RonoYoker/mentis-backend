...
class CED_HIS_CampaignContentMediaMapping(Base, Orm_helper):
    __tablename__ = 'CED_HIS_CampaignContentMediaMapping'

    id = Column("Id", Integer, unique=True)
    unique_id = Column("UniqueId", String, primary_key=True)
    media_mapping_id = Column("MediaMappingId", String)

...
class CED_HIS_Segment_Filter(Base, Orm_helper):
    __tablename__ = 'CED_HIS_Segment_Filter'

    id = Column("Id", Integer, primary_key=True)
    unique_id = Column("UniqueId", String, unique=True)
    segment_id = Column("SegmentId")
    master_id = Column("MasterId", String)
    segment_filter_id = Column("SegmentFilterId", String)

...
QUERY_EXECUTION_JOB_BUCKET = "sbi-prod-async-query-execution-response"
SNS_SEGMENT_EVALUATOR = "PROD_HYP_DK_Campaign_Segment_Evaluator"
AWS_REGION = "ap-south-1"
AWS_ACCOUNTID = '058264535272'

MKT_CLICKDATA_FLAG = False
SANDESH_SEND_COMM = "http://m-prod-sandesh-elb-1508579950.ap-south-1.elb.amazonaws.com/api/send_communication"
